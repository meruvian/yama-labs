...
angular.module('websocketApp').controller('ApplicationCtrl', function ($scope, $modal, $location, Applications, angularPopupBoxes, ngstomp) {
	...
	ngstomp.subscribe('/topic/crud/Application', function(msg) {
		var a, app = JSON.parse(msg.body);

		angular.forEach($scope.applications, function(r) {
			if (r.id === app.id) {
				a = angular.extend(r, app);
			}
		});
